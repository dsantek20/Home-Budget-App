...
@category_router.get("/predefined/expense", response_model=List[CategoryGet])
async def get_predefined_expense_categories(service: CategoryServiceInstance):
    return await service.get_predefined_expense_categories()

@category_router.get("/predefined/income", response_model=List[CategoryGet])
async def get_predefined_income_categories(service: CategoryServiceInstance):
    return await service.get_predefined_income_categories()
...
@category_router.get("/custom/expense", response_model=List[CategoryGet])
async def get_user_custom_expense_categories(current_user: CurrentUser, service: CategoryServiceInstance):
    return await service.get_user_custom_expense_categories(current_user)

@category_router.get("/custom/income", response_model=List[CategoryGet])
async def get_user_custom_income_categories(current_user: CurrentUser, service: CategoryServiceInstance):
    return await service.get_user_custom_income_categories(current_user)
...
@category_router.get("/expense", response_model=List[CategoryGet])
async def get_expense_categories(current_user: CurrentUser, service: CategoryServiceInstance):
    return await service.get_expense_categories(current_user)

@category_router.get("/income", response_model=List[CategoryGet])
async def get_income_categories(current_user: CurrentUser, service: CategoryServiceInstance):
    return await service.get_income_categories(current_user)
...
async def create_new_category(current_user: CurrentUser, request: CategoryCreate, service: CategoryServiceInstance):
